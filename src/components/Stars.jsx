...
function Star({ onRate, isFull, color, size }) {
  // props api : set props for reusebility to make basic modification easy for reciever of component
